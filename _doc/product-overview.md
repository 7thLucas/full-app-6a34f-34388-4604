...
## Core Features
- Interactive 5×5 game board (clickable cells)
- Turn-based play: X always goes first, players alternate
- Win detection: checks all 12 win conditions (5 rows, 5 columns, 2 diagonals) after every move
- Draw detection: triggers when all 25 cells are filled with no winner
